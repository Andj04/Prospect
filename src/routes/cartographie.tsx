      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Entreprises qualifiées par projet Amal Biladi — une entreprise liée à plusieurs projets
            apparaît une fois par projet.
          </p>
        </div>
          ...
          {isAdmin && (
            <div className="ml-auto flex items-center gap-2">
              ...
              <Button
                ...
                disabled={saveMindmapPositions.isPending}
              >
